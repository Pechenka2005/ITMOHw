...
happyExpList = Happy_Data_Array.listArray (0,34) ([6272,3136,384,32,0,196,0,49,0,8195,4102,3,2,25088,0,0,0,64,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parser","Expr","Disj","Conj","Neg","'!'","'&'","'|'","\"->\"","var","'('","')'","%eof"]
